  ...
  <section class="main-content">
    <div class="process-order-container">
        ...
        <div class="po-nav-con">
            <ul class="po-nav">
                <li><a id="enable" href="partials/customize.php">Customize</a></li>
                <li><a id="disable" href="partials/checkout.php">Checkout</a></li>
                <li><a  id="disable"href="partials/payment.php">Payment</a></li>
            </ul>            
        </div>
